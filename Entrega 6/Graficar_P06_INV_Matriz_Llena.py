...
fid = open(f"Entrega_P06_INV_Matriz_Llena.txt","r")
...
labels_x = ["10","20","50","100","200","500", "1000","2000","5000","10000","13000","20000"]
Ns1 = [10,20,50,100,200,500,1000,2000,5000,10000,13000,20000]
...
plt.title("Rendimiento INV para Matriz LLENA")
...
plt.tight_layout()
plt.savefig("plot_P06_INV_Matriz_Llena.png")
