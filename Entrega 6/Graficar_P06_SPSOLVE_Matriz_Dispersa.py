...
fid = open(f"Entrega_P06_SPSOLVE_Matriz_Dispersa.txt","r")
...
labels_x = ["10","20","50","100","200","500", "1000","2000","5000","10000","20000","50000","100000","1000000","10000000"]
Ns1 = [10,20,50,100,200,500,1000,2000,5000,10000,20000,50000,100000,1000000,10000000]
...
plt.title("Rendimiento SPSOLVE para Matriz DISPERSA")
...
plt.tight_layout()
plt.savefig("plot_P06_SPSOLVE_Matriz_Dispersa.png")
