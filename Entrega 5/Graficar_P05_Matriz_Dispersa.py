...
fid = open(f"Entrega_P05_Matriz_Dispersa.txt","r")
...
labels_x = ["10","20","50","100","200","500", "1000","2000","5000","10000","20000","50000","100000","1000000","10000000","100000000"]
Ns1 = [10,20,50,100,200,500,1000,2000,5000,10000,20000,50000,100000,1000000,10000000,100000000]
...
plt.title("Rendimiento A@B para Matriz DISPERSA")
...
#plt.plot(O_N5_x, O_N5_y, color='g', linestyle='--', label="$\mathregular{O(N^5)}$")
...
#plt.plot(O_N5_x_s, O_N5_y_s, color='g', linestyle='--', label="O(N5)")
...
plt.tight_layout()
plt.savefig("plot_P05_Matriz_Dispersa.png")
