...
fid = open(f"Entrega_P05_Matriz_Llena.txt","r")
...
g=18000*((0.000001/yf)**(1/2))
O_N2_x = [g,18000]
O_N2_y = [0.00001,yf]


g=18000*((0.000001/yf)**(1/3))
O_N3_x = [g,18000]
O_N3_y = [0.00001,yf]

g=18000*((0.000001/yf)**(1/4))
O_N4_x = [g,18000]
O_N4_y = [0.00001,yf]

g=18000*((0.000001/yf)**(1/5))
O_N5_x = [g,18000]
O_N5_y = [0.00001,yf]
...
plt.title("Rendimiento A@B para Matriz LLENA")
...
plt.tight_layout()
plt.savefig("plot_P05_Matriz_Llena.png")
