...
fid = open(f"rendimiento_P04_eigh64_caso_I.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_II_overwrite_False.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_II_overwrite_True.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_III_overwrite_False.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_III_overwrite_True.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_IV_overwrite_False.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_IV_overwrite_True.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_V_overwrite_False.txt","r")
...
fid = open(f"rendimiento_P04_eigh64_caso_V_overwrite_True.txt","r")
...
plt.title("Rendimiento Eigh dtype = float64")
...
plt.tight_layout()
plt.legend()
plt.savefig("plot_caso_Eigh_64.png")
