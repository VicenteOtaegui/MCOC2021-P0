...
fid = open(f"rendimiento_P04_eigh32_caso_IV_overwrite_False.txt", "w")
...
fid = open(f"rendimiento_P04_eigh64_caso_IV_overwrite_False.txt", "w")
...
fid = open(f"rendimiento_P04_eigh32_caso_IV_overwrite_True.txt", "w")
...
fid = open(f"rendimiento_P04_eigh64_caso_IV_overwrite_True.txt", "w")
