...
Ns = 	[2,5,10,20,40,60,80,100,120,140,160,180,200,220,
...
fid = open(f"rendimiento_P04_eigh32_caso_III_overwrite_False.txt", "w")
...
fid = open(f"rendimiento_P04_eigh64_caso_III_overwrite_False.txt", "w")
...
fid = open(f"rendimiento_P04_eigh32_caso_III_overwrite_True.txt", "w")
...
fid = open(f"rendimiento_P04_eigh64_caso_III_overwrite_True.txt", "w")
