...
fid = open(f"rendimiento_P04_solve32_caso_I.txt","r")
...
fid = open(f"rendimiento_P04_solve32_caso_II.txt","r")
...
fid = open(f"rendimiento_P04_solve32_caso_III.txt","r")
...
fid = open(f"rendimiento_P04_solve32_caso_IV.txt","r")
...
fid = open(f"rendimiento_P04_solve32_caso_V.txt","r")
...
fid = open(f"rendimiento_P04_solve32_caso_VI.txt","r")
...
fid = open(f"rendimiento_P04_solve32_caso_VII.txt","r")
...
plt.title("Rendimiento Solve dtype = float32")
...
plt.tight_layout()
plt.legend()
plt.savefig("plot_caso_Solve_32.png")
