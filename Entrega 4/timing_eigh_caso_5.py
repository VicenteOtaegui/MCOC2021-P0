...
fid = open(f"rendimiento_P04_eigh32_caso_V_overwrite_False.txt", "w")
...
fid = open(f"rendimiento_P04_eigh64_caso_V_overwrite_False.txt", "w")
...
fid = open(f"rendimiento_P04_eigh32_caso_V_overwrite_True.txt", "w")
...
fid = open(f"rendimiento_P04_eigh64_caso_V_overwrite_True.txt", "w")
